...
export type Settings={CAPTURE_MODE?:string;SITE_ORIGIN?:string;CRM_API_TOKEN?:string;CRM_WEBHOOK_URL?:string;CRM_WEBHOOK_SECRET?:string;CRM_ADMIN_EMAILS?:string;PRIVACY_CONTACT?:string;LEGAL_NAME?:string;RETENTION_DAYS?:string;ANALYTICS_ENABLED?:string;RATE_LIMIT_SECRET?:string;DB?:D1Database;BUCKET?:R2Bucket};
