...
await build({
  entryPoints:["tests/crm-deep-link.test.tsx"],
  outfile:".sites-runtime/crm-deep-link.test.mjs",
...
const result=spawnSync(process.execPath,["--test",".sites-runtime/crm-deep-link.test.mjs"],{stdio:"inherit"});
