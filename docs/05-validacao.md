...
Pendências: fatos comerciais, controlador, retenção/base legal, destino CRM, agendador, fotos reais, fonte exata da logo [VALIDAR]. Deploy deve ser confirmado pelo status terminal da hospedagem. Build local sozinho não comprova publicação.
